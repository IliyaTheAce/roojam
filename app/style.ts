const styles = {
  ...
  heading2:
    "font-yekan font-semibold xs:text-[48px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full",
  paragraph:
    "font-yekan font-normal text-dimWhite text-[18px] leading-[30.8px]",
